...
>
  ...
  <div className="flex items-center gap-4 flex-wrap md:flex-nowrap">
    ...
    <button
      disabled={isTeamMember}
      className={`flex items-center justify-center gap-2 px-8 h-11 rounded-[8px] border border-white/10 text-white text-[14px] transition-all ${
        isTeamMember
          ? "opacity-50 cursor-not-allowed bg-[#1C1C1E]"
          : "bg-[#1C1C1E] hover:bg-gradient-to-r hover:from-[#5A3FFF] hover:to-[#FF14EF]"
      }`}
    ...
    {/* Buy Now */}
 {/* ✅ Buy Now Button - one line version */}
<button
  disabled={isTeamMember}
  onClick={() => !isTeamMember && onPurchase?.(prompt)}
  className={`flex items-center justify-center px-10 h-11 rounded-[8px] font-medium text-white text-[14px] transition-all ${
    isTeamMember
      ? "opacity-50 cursor-not-allowed bg-gradient-to-r from-gray-600 to-gray-500"
